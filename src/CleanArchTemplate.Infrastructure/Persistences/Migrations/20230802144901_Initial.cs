...
namespace CleanArchTemplate.Infrastructure.Persistences.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DriverServices", x => new { x.DriversId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_DriverServices_Drivers_DriversId",
                        column: x => x.DriversId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DriverServices_Services_ServicesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverServices_ServicesId",
